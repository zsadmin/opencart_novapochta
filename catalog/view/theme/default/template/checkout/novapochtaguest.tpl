...
<div class="right">
    ...
    <div style="display: none;">
        ...
        <input type="text" name="address_2" value="<?php echo $address_2; ?>" class="large-field" /></div>
    ...
    <div id="otdel1">
        ...
        <select id ="otdel" style="width: 235px" name="address_1" class="large-field"></select>
        <br />
    </div>
    <br />
    <br />
...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #DDDDDD; display: none;">
