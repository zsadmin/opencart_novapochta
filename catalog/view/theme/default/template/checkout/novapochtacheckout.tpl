...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochtapayment_address',
		dataType: 'html',
		success: function(html) {
...
$('#button-account').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochta' + $('input[name=\'account\']:checked').attr('value'),
		dataType: 'html',
		beforeSend: function() {
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=checkout/novapochtashipping_address',
								dataType: 'html',
								success: function(html) {
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochtapayment_address/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochtashipping_address/validate',
		type: 'post',
...
$('#button-guest').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochtaguest/validate',
		type: 'post',
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['address_1']) {
					$('#payment-address select[name=\'address_1\'] + br').after('<span class="error">' + json['error']['address_1'] + '</span>');
				}	
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=checkout/novapochtaguest_shipping',
								dataType: 'html',
								success: function(html) {
									$('#shipping-address .checkout-content').html(html);
								},
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/novapochtaguest_shipping/validate',
		type: 'post',
