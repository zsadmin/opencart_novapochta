...
class ControllerCheckoutNovapochtapaymentAddress extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/novapochtapayment_address.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/novapochtapayment_address.tpl';
		} else {
			$this->template = 'default/template/checkout/novapochtapayment_address.tpl';
		}
