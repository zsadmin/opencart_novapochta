...
class ControllerAccountNovapochtaregister extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/novapochtaregister.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/novapochtaregister.tpl';
		} else {
			$this->template = 'default/template/account/novapochtaregister.tpl';
		}
