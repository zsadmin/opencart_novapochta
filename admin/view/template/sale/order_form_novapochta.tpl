...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <div id="vtabs" class="vtabs"><a href="#tab-novapochta"><?php echo $tab_novapochta; ?></a><a href="#tab-customer"><?php echo $tab_customer; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a><a href="#tab-shipping"><?php echo $tab_shipping; ?></a><a href="#tab-product"><?php echo $tab_product; ?></a><a href="#tab-voucher"><?php echo $tab_voucher; ?></a><a href="#tab-total"><?php echo $tab_total; ?></a></div>
            <form id="pochta" action="<?php echo $pochta_action; ?>" method="post" enctype="multipart/form-data" id="form" >
                <input type="hidden" name="order_id" value="<?php echo $order_id; ?>" />
            <div id="tab-novapochta" class="vtabs-content">
                <div id="notification"></div>
                <?php if (!empty($np_order)){ ?>
                <h2 class="np_hide"><?php echo $number_h2; ?><a target="_blank" href="https://my.novaposhta.ua/orders/printDocument/orders/<?php echo $np_order; ?>/type/html/apiKey/<?php echo $np_key; ?>"><?php echo $np_order; ?></a></h2>
                <a class="button pochta_cancel np_hide"><?php echo $button_cancel; ?></a>
                <?php } ?>
                <table class="form np_hide" <?php if (!empty($np_order)){ echo 'style="display: none;"'; }?>>
                <tr>
                    <td style="width: 250px;"><h2><?php echo $entry_sender_h2; ?></h2></td>
                    <td></td>
                    <td style="width: 250px;"><h2><?php echo $entry_rcpt_h2; ?></h2></td>
                    <td style="float: right;"><a class="button pochta"><?php echo $button_create; ?></a></td>
                </tr>
                <tr>
                    <td>
                        <?php echo $entry_city_from; ?>
                    </td>
                    <td><input id="db_city_from" type="text" name="novaposhta_city_from" value="<?php echo $novaposhta_city_from; ?>" /></td>
                    <td>
                        <?php echo $rcpt_city_name; ?>
                    </td>
                    <td><input id="db_city" type="text" name="novaposhta_shipping_city" value="<?php echo $shipping_city; ?>" /></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <select name="type_sender_counterpart">
                            <option <?php if($novaposhta_type_counterpart == 'Organization') echo 'selected="selected"'; ?> value="Organization"><?=$type_counterpart_1;?></option>
                            <option <?php if($novaposhta_type_counterpart == 'PrivatePerson') echo 'selected="selected"'; ?> value="PrivatePerson"><?=$type_counterpart_2;?></option>
                        </select>
                    </td>
                    <td>
                        <?php echo $type_counterpart; ?>
                ...
                <tr>
                    ...
                    <td>
                        <select id="otdel_sender"  name="novaposhta_sender_address" class="large-field" style="width:136px;">
                            <?php foreach ($otel_novaposhta_city_from as $k=>$v) { ?>
                    ...
                    <td>
                        <?php echo $rcpt_warehouse; ?>
                    </td>
                    <td>
                        <select id="otdel"  name="novaposhta_shipping_address_2" class="large-field" style="width:136px;">
                            <?php foreach ($otel_adress as $k=>$v) { ?>
                            <?php if ($v == $shipping_address_2 ){ ?>
                            <option selected="selected" value="<?php echo $k; ?>"><?php echo $v; ?></option>
                            <?php } else { ?>
                            <option value="<?php echo $k; ?>"><?php echo $v; ?></option>
                            <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $rcpt_contact; ?>
                    </td>
                    <td><input type="text" name="novaposhta_shipping_firstname" value="<?php echo $shipping_lastname . ' ' . $shipping_firstname ?>" /></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <?php echo $rcpt_phone_num; ?>
                    </td>
                    <td><input type="text" name="novaposhta_telephone" value="<?php echo $telephone; ?>" /></td>
                </tr>
                </table>
                <h2 class="np_hide" <?php if (!empty($np_order)){ echo 'style="display: none;"'; }?>><?php echo $order_details_h2; ?></h2>
                <table class="form np_hide" <?php if (!empty($np_order)){ echo 'style="display: none;"'; }?>>
                <tr>
                    <td>
                    ...
                    <td><select name="novaposhta_type">
                            <option <?php if($novaposhta_type == 1)echo 'selected="selected"'; ?> value="DoorsDoors"><?=$entry_type_1;?></option>
                            <option <?php if($novaposhta_type == 2)echo 'selected="selected"'; ?> value="DoorsWarehouse"><?=$entry_type_2;?></option>
                            <option <?php if($novaposhta_type == 3)echo 'selected="selected"'; ?> value="WarehouseDoors"><?=$entry_type_3;?></option>
                            <option <?php if($novaposhta_type == 4)echo 'selected="selected"'; ?> value="WarehouseWarehouse"><?=$entry_type_4;?></option>
                        </select></td>
                </tr>
                <tr>
                    <td>
                        <?php echo $entry_cargo_type; ?>
                    </td>
                    <td><select name="novaposhta_cargo_type">
                            <option selected="selected" value="Cargo"><?=$entry_cargo_type_1;?></option>
                            <option value="Documents"><?=$entry_cargo_type_2;?></option>
                            <option value="TiresWheels"><?=$entry_cargo_type_3;?></option>
                            <option value="Pallet"><?=$entry_cargo_type_4;?></option>
                        </select></td>
                </tr>
                <tr>
                    <td>
                        <span class="required">*</span> <?php echo $novapochta_description; ?>
                    </td>
                    <td><textarea name="novaposhta_description"></textarea></td>
                </tr>
                <tr>
                    <td>
                        <?php echo $pay_type; ?>
                    ...
                    <td>
                        <input id="type_cash" type="radio" name="novaposhta_pay_type" checked="checked" value="Cash"><?php echo $cash; ?><br>
                        <input id="type_non_cash" type="radio" name="novaposhta_pay_type" value="NonCash"><?php echo $no_cash; ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input class="payer" type="radio" name="novaposhta_payer" value="Recipient"><?php echo $payer0; ?><br>
                        <input class="payer" type="radio" name="novaposhta_payer" checked="checked" value="Sender"><?php echo $payer1; ?><br>
                        <input class="payer" type="radio" name="novaposhta_payer" value="ThirdPerson"><?php echo $payer2; ?>
                    </td>
                </tr>
                <tr>
                    <td>
                        <span class="required">*</span> <?php echo $entry_publicPrice; ?>
                    </td>
                    <td><input type="text" name="novaposhta_publicPrice" value="<?php echo $novaposhta_publicPrice; ?>" /></td>
                </tr>
                <tr>
                    <td>
                        <span class="required">*</span> <?php echo $entry_mass; ?>
                    </td>
                    <td><input type="text" name="novaposhta_mass" value="<?php echo $novaposhta_mass; ?>" /></td>
                </tr>
                <tr>
                    <td>
                        <span class="required">*</span> <?php echo $entry_volume_general; ?>
                    </td>
                    <td><input type="text" name="novaposhta_volume_general" value="<?php echo $novaposhta_volume_general; ?>" /></td>
                </tr>
                <tr>
                    <td>
                        <?php echo $need_date; ?>
                    </td>
                    <td><input class="novapochta_date" type="text" size="12" value="<?php echo date('d.m.Y'); ?>" name="novaposhta_need_date"></td>
                </tr>
                </table>
            </div>
            </form>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#db_city_from').autocomplete({
            ...
            select: function(event, ui) {
                $.post("/index.php?route=module/novapochta/ajax_otdel", {"city_id": ui.item.id}, function(data) {
                    ...
                    $('#otdel_sender').html('');
                    for (var i in obj) {
                        $('#otdel_sender').append('<option value="' + obj[i].number + '">' + obj[i].address + '</option>');
                    }
                });
            }

        });
        $('#db_city_payer').autocomplete({
            source: "/index.php?route=module/novapochta/ajax_city",
            minLength: 2
        ...
        $(".payer").change(function() {
            if ($(this).val() == 'ThirdPerson') {
                $('#type_non_cash').prop('checked', true);
                $('#type_cash').prop('disabled', true);
            } else {
                $('#type_cash').prop('disabled', false);
                $('.clean_payer').val('');
            }

        });
        $('.pochta').click(function() {
            $.post("/index.php?route=module/novapochta/ajax_create_shipping", $('#pochta').serialize(), function(data) {
                $('.success, .warning, .attention, .information, .error').remove();
                data = jQuery.parseJSON(data);
                if (data.success) {
                    $('#notification').html('<div class="success" style="display: none;"><?php echo $number_alert; ?><a target="_blank" href="http://print.novaposhta.ua/index.php?r=site/ttn&id=' + data.success + '&num_copy=1&token=<?php echo $np_key; ?>">' + data.success + '</a><img src="/catalog/view/theme/default/image/close.png" alt="" class="close" style="cursor: pointer;float: right; padding-right: 4px; padding-top: 4px;" /></div>');
                    $('.success').fadeIn('slow');
                ...
                if (data.error) {
                    $('#notification').html('<div class="warning" style="display: none;">' + data.error + '<img src="/catalog/view/theme/default/image/close.png" alt="" class="close" style="cursor: pointer;float: right; padding-right: 4px; padding-top: 4px;" /></div>');
                    $('.warning').fadeIn('slow');
                    $('html, body').animate({scrollTop: 0}, 'slow');
                    $('.close').click(function() {
                        $('.success, .warning, .attention, .information, .error').remove();
        ...
        $('.pochta_cancel').click(function() {
            $.post("/index.php?route=module/novapochta/ajax_cancel_shipping", {np_id: "<?php echo $np_order; ?>"}, function(data) {
                if (data == 'CANCELED' || data == 'DELETED') {
                    $('#notification').html('<div class="success" style="display: none;">Отменен<img src="/catalog/view/theme/default/image/close.png" alt="" class="close" style="cursor: pointer;float: right; padding-right: 4px; padding-top: 4px;" /></div>');
                    $('.success').fadeIn('slow');
                    $('html, body').animate({scrollTop: 0}, 'slow');
                    $('.close').click(function() {
                        $('.success, .warning, .attention, .information, .error').remove();
