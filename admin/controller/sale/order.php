...
class ControllerSaleOrder extends Controller {
    ...
    public function getForm() {
        ...
        foreach ($order_products as $order_product) {
            if (isset($order_product['price'])){
                if(isset($order_product['quantity'])){
                    $publicPrice += $order_product['price'] * $order_product['quantity'];
                }else{
                    $publicPrice += $order_product['price'];
                }
            }
        ...
        if (!empty($this->data['shipping_code']) && $this->data['shipping_code'] == 'novaposhta.novaposhta') {
            $this->novapochta_page();
        } else {
            //$this->novapochta_page();
    ...
    public function novapochta_page() {

        $this->load->language('shipping/novaposhta');
        $this->load->model('module/novapochta');

        $this->data['tab_novapochta'] = $this->language->get('tab_novapochta');
        $this->data['entry_sender_h2'] = $this->language->get('entry_sender_h2');
        $this->data['order_details_h2'] = $this->language->get('order_details_h2');
        $this->data['pack_type'] = $this->language->get('pack_type');
        $this->data['novapochta_description'] = $this->language->get('novapochta_description');
        $this->data['pay_type'] = $this->language->get('pay_type');
        $this->data['cash'] = $this->language->get('cash');
        $this->data['no_cash'] = $this->language->get('no_cash');
        $this->data['payer'] = $this->language->get('payer');
        $this->data['payer0'] = $this->language->get('payer0');
        $this->data['payer1'] = $this->language->get('payer1');
        $this->data['payer2'] = $this->language->get('payer2');
        $this->data['entry_rcpt_h2'] = $this->language->get('entry_rcpt_h2');
        $this->data['rcpt_city_name'] = $this->language->get('rcpt_city_name');
        $this->data['rcpt_name'] = $this->language->get('rcpt_name');
        $this->data['rcpt_warehouse'] = $this->language->get('rcpt_warehouse');
        $this->data['rcpt_contact'] = $this->language->get('rcpt_contact');
        $this->data['rcpt_phone_num'] = $this->language->get('rcpt_phone_num');
        ...
        $this->data['need_date'] = $this->language->get('need_date');
        $this->data['date_desired'] = $this->language->get('date_desired');
        $this->data['payer_city'] = $this->language->get('payer_city');
        $this->data['payer_company'] = $this->language->get('payer_company');
        $this->data['entry_volume_general'] = $this->language->get('entry_volume_general');
        $this->data['saturday'] = $this->language->get('saturday');
        ...
        $this->data['number_h2'] = $this->language->get('number_h2');
        $this->data['number_alert'] = $this->language->get('number_alert');
        ...
        $this->data['entry_cargo_type'] = $this->language->get('entry_cargo_type');
        $this->data['entry_cargo_type_1'] = $this->language->get('entry_cargo_type_1');
        $this->data['entry_cargo_type_2'] = $this->language->get('entry_cargo_type_2');
        $this->data['entry_cargo_type_3'] = $this->language->get('entry_cargo_type_3');
        $this->data['entry_cargo_type_4'] = $this->language->get('entry_cargo_type_4');
        ...
        $this->data['novaposhta_type_counterpart'] = $this->config->get('type_shipping_counterpart');
        ...
        foreach($totals as $item){
            if($item['code'] == 'sub_total'){
                $sub_total = floatval($item['value']);
                break;
            }
        }
        $this->data['novaposhta_publicPrice'] = $sub_total;

        if (!isset($this->data['novaposhta_mass'])) {
            $this->data['novaposhta_mass'] = $this->model_module_novapochta->get_mass($this->request->get['order_id']);
        }
        $this->data['np_key'] = $this->config->get('novaposhta_key');
        $this->data['pochta_action'] = $this->url->link('sale/order/create_shipping', 'token=' . $this->session->data['token']);

        $this->data['otel_novaposhta_city_from'] = $this->model_module_novapochta->get_otdel_address($this->data['novaposhta_city_from']);
        $this->data['otel_adress'] = $this->model_module_novapochta->get_otdel_address($this->data['shipping_city']);
        $this->data['np_order'] = $this->model_module_novapochta->get_np_order($this->data['order_id']);

        $this->template = 'sale/order_form_novapochta.tpl';
    }
